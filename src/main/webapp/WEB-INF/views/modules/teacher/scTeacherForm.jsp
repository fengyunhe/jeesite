...
<body>
	...
	<form:form id="inputForm" modelAttribute="scTeacherVo" action="${ctx}/teacher/scTeacher/save" method="post" class="form-horizontal">
		<form:hidden path="id"/>
		<sys:message content="${message}"/>
		<div class="control-group">
			<label class="control-label">教师编号：</label>
			<div class="controls">
				<form:input path="teNo" htmlEscape="false" maxlength="10" class="input-xlarge "/>
			</div>
		</div>
		<div class="control-group">
		...
		<div class="control-group">
			...
			<div class="controls">
				<form:hidden id="photoUrl" path="photoUrl" htmlEscape="false" maxlength="2000" class="input-xlarge"/>
				<sys:ckfinder input="photoUrl" type="images" uploadPath="/teacher/scTeacher" selectMultiple="false"/>
			</div>
		</div>
		<div class="control-group">
		...
		<div class="control-group">
			...
			<div class="controls">
				<form:input path="wechat" htmlEscape="false" maxlength="30" class="input-xlarge "/>
			</div>
		</div>
		<div class="control-group">
		...
		<div class="control-group">
			<label class="control-label">主要学科：</label>
			<div class="controls">
		...
		<div class="control-group">
			<label class="control-label">职称等级：</label>
			<div class="controls">
				<form:select path="levelId" class="input-xlarge ">
					<form:option value="" label=""/>
		...
		<div class="control-group">
			...
			<div class="controls">
				<form:select path="jobId" class="input-xlarge ">
					<form:option value="" label=""/>
		...
		<div class="control-group">
			...
			<div class="controls">
				<input name="birthday" type="text" readonly="readonly" maxlength="20" class="input-medium Wdate "
					value="<fmt:formatDate value="${scTeacherVo.birthday}" pattern="yyyy-MM-dd"/>"
		...
		<div class="form-actions">
			<shiro:hasPermission name="teacher:scTeacher:edit"><input id="btnSubmit" class="btn btn-primary" type="submit" value="保 存"/>&nbsp;</shiro:hasPermission>
